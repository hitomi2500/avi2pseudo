...
void Codec_Btree1::Pack(QVector<QVector<unsigned char>> Curr_Values, QVector<QVector<unsigned char>> Prev_Values, QByteArray * packed)
{
    int i,j,k,z;
    uchar c,c2;
    int btree_first[8];
    ...
    //calculate fourth, 51*8*8 = 3264 blocks
    for (iblock=0;iblock<4096;iblock++) btree_fourth[iblock] = 0;
    for (iblock=0;iblock<3264;iblock++)
    {
...
void Codec_Btree1::Unpack(QByteArray * packed, QVector<QVector<unsigned char>>* Unpack_Values, QImage* unpack_image)
{
